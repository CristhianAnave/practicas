    ...
    public partial class FrmCategoria : Form
    {
		...
		private void btnGuardar_Click(object sender, EventArgs e)
		{
			if (validar())
			{
				...
				if (esNuevo)
				{
					...
					{
						MessageBox.Show("NO SE PUEDE AGREGAR, descripción ya existente.", ":::Licoreria - Mensaje :::",
				...
				else
				{
					...
					{
						MessageBox.Show("NO SE PUEDE ACTUALIZAR, descripción ya existente.", ":::Licoreria - Mensaje :::",
							MessageBoxButtons.OK, MessageBoxIcon.Warning);
				...
				listar();
				MessageBox.Show("Categoria guardado correctamente", ":::Licoreria - Mensaje :::",
		...
		private void btnEliminar_Click(object sender, EventArgs e)
		{
			...
			if (dialog == DialogResult.OK)
			{
				...
				listar();
				MessageBox.Show("Categoria dado de baja correctamente", "::: Licoreria - Mensaje :::",
					MessageBoxButtons.OK, MessageBoxIcon.Information);
			}
			limpiar();
		}
